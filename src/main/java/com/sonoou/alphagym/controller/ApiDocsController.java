...
public class ApiDocsController {
    ...
    public ResponseEntity<Map<String, Object>> getApiDocumentation() {
        ...
        // 6. User Profile, Routine, Streaks & Schedule
    ...
    public ResponseEntity<Map<String, Object>> getOpenApiJson() {
        ...
        // Helper for building OpenAPI operation
        // Health & System
        ...
        paths.put("/api/payment/verify", Map.of("post", createOperation("Verify Razorpay Payment", "Verify Razorpay HMAC SHA256 payment signature", true, Map.of("razorpayOrderId", "order_MZk123456", "razorpayPaymentId", "pay_MZn876543", "razorpaySignature", "9f8e7d6c..."), Map.of("200", createResponse("Verification Status", Map.of("status", "SUCCESS", "message", "Payment verified successfully"))))));
        ...
        paths.put("/api/user/profile", Map.of(
                "get", createOperation("Get User Profile", "Get current user profile details", true, null, Map.of("200", createResponse("User Profile", Map.of("id", 1, "name", "John Doe", "email", "john@example.com")))),
        ...
        paths.put("/api/user/routine", Map.of(
                "get", createOperation("Get User Routine", "Get saved workout routine list", true, null, Map.of("200", createResponse("Routine Workouts List", List.of(Map.of("id", 1, "name", "Bench Press"))))),
        ...
        // Workouts & Categories
        paths.put("/api/workouts", Map.of("get", createOperation("Get Workouts List", "Get workouts (optional ?category=Chest filter)", false, null, Map.of("200", createResponse("Workouts List", List.of(Map.of("id", 1, "name", "Bench Press", "category", "Chest")))))));
        paths.put("/api/categories", Map.of("get", createOperation("Get Categories List", "Get workout categories list", false, null, Map.of("200", createResponse("Categories List", List.of(Map.of("id", 1, "name", "Chest", "icon", "fitness")))))));
