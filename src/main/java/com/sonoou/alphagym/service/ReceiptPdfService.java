...
public class ReceiptPdfService {
    ...
    public byte[] generateReceiptPdf(Long transactionId, String currentUserEmail) {
        ...
        // Security check: currentUserEmail must match transaction user email (unless admin)
    ...
    private byte[] buildPdf(PaymentTransactionEntity tx, UserEntity user) {
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            // Receipt Slip Dimensions (approx 595 x 380 - Landscape Receipt Slip)
            Rectangle pageSize = new Rectangle(595, 380);
            ...
            writer.setPageEvent(new PdfPageEventHelper() {
                ...
                public void onEndPage(PdfWriter writer, Document doc) {
                    ...
                    cb.setColorStroke(new Color(40, 40, 40));
                    cb.setLineWidth(2.0f);
                    // Outer border
                    cb.roundRectangle(15, 15, doc.getPageSize().getWidth() - 30, doc.getPageSize().getHeight() - 30, 8);
                    cb.stroke();
                }
            });
            ...
            // Fonts setup
            BaseFont unicodeBase = getUnicodeBaseFont();
            Font gymTitleFont = new Font(Font.HELVETICA, 19, Font.BOLD | Font.ITALIC, new Color(20, 20, 20));
            Font addressFont = new Font(Font.HELVETICA, 8.5f, Font.NORMAL, new Color(50, 50, 50));
            Font boldLabelFont = new Font(Font.HELVETICA, 10, Font.BOLD, new Color(30, 30, 30));
            Font normalFont = new Font(Font.HELVETICA, 9.5f, Font.NORMAL, new Color(30, 30, 30));
            Font scriptFont = new Font(Font.HELVETICA, 11.5f, Font.BOLD | Font.ITALIC, new Color(10, 40, 110));
            Font noticeFont = (unicodeBase != null) ? new Font(unicodeBase, 7.5f, Font.NORMAL, new Color(60, 60, 60))
                    : new Font(Font.HELVETICA, 7.5f, Font.NORMAL, new Color(60, 60, 60));
            Font noticeBoldFont = (unicodeBase != null) ? new Font(unicodeBase, 8.5f, Font.BOLD, new Color(30, 30, 30))
                    : new Font(Font.HELVETICA, 8.5f, Font.BOLD, new Color(30, 30, 30));
            ...
            Paragraph logoP = new Paragraph("AV\nGFP", new Font(Font.HELVETICA, 13, Font.BOLD, new Color(30, 30, 30)));
            logoP.setAlignment(Element.ALIGN_LEFT);
            Paragraph subLogo = new Paragraph("Alpha Veins Gym", new Font(Font.HELVETICA, 7, Font.NORMAL, new Color(80, 80, 80)));
            subLogo.setAlignment(Element.ALIGN_LEFT);
            String receiptNumber = String.format("%04d", tx.getId());
            Paragraph recNoP = new Paragraph("\nNo.: " + receiptNumber, new Font(Font.HELVETICA, 10, Font.BOLD, new Color(30, 30, 30)));
            ...
            Paragraph mobP = new Paragraph("Mob. No. : 9971241014", new Font(Font.HELVETICA, 8.5f, Font.BOLD, new Color(40, 40, 40)));
            mobP.setAlignment(Element.ALIGN_RIGHT);
            Paragraph waP = new Paragraph("WhatsApp: 9643055173", new Font(Font.HELVETICA, 8.5f, Font.NORMAL, new Color(40, 40, 40)));
            ...
            line1Table.setWidths(new float[]{32f, 68f});
            ...
            line2Table.setWidths(new float[]{25f, 75f});
            ...
            line3Table.setWidths(new float[]{12f, 25f, 15f, 48f});
            
            Double amount = tx.getAmount() != null ? tx.getAmount() : 0.0;
            String paymentId = tx.getRazorpayPaymentId() != null ? tx.getRazorpayPaymentId() : "Razorpay Verified (" + tx.getStatus() + ")";
            ...
            PdfPCell l3OnlineVal = new PdfPCell(new Phrase("₹" + String.format("%.0f", amount) + " (" + paymentId + ")", scriptFont));
            ...
            // Line 4: Highlighted Receipt Amount Box + Notes
            PdfPTable amountRow = new PdfPTable(2);
            amountRow.setWidthPercentage(100);
            amountRow.setWidths(new float[]{40f, 60f});
            ...
            amountBoxCell.setBackgroundColor(new Color(245, 247, 250));
            Paragraph amountP = new Paragraph("Receipt   ₹ " + String.format("%.0f", amount) + "/-", new Font(Font.HELVETICA, 13, Font.BOLD, new Color(20, 20, 20)));
            ...
            Paragraph noteP = new Paragraph("Note : We Also Provide Personal Training And Customised Diet Chart*", new Font(Font.HELVETICA, 8, Font.BOLD, new Color(30, 30, 30)));
            Paragraph noticeHead = new Paragraph("आवश्यक सूचना :", noticeBoldFont);
            Paragraph noticeBody1 = new Paragraph("• जीम के अन्दर कोई भी कीमती वस्तु जैसे मोबाईल, घड़ी, पर्स आदि का स्वयं ध्यान रखें।", noticeFont);
            Paragraph noticeBody2 = new Paragraph("• किसी भी प्रकार के नुकसान की जिम्मेदारी प्रबंधक की नहीं होगी।", noticeFont);
            ...
            Paragraph forGym = new Paragraph("For Alpha Veins Gym", new Font(Font.HELVETICA, 10, Font.BOLD | Font.ITALIC, new Color(20, 20, 20)));
            forGym.setAlignment(Element.ALIGN_RIGHT);
            Paragraph signLine = new Paragraph("\nAuthorized Signatory", new Font(Font.HELVETICA, 8.5f, Font.BOLD, new Color(40, 40, 40)));
            signLine.setAlignment(Element.ALIGN_RIGHT);
            Paragraph signatureLabel = new Paragraph("Signature", new Font(Font.HELVETICA, 8, Font.ITALIC, new Color(80, 80, 80)));
